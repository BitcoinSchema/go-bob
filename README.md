...
[![Build Status](https://travis-ci.com/BitcoinSchema/go-bob.svg?branch=master&v=3)](https://travis-ci.com/BitcoinSchema/go-bob)
...
## Examples & Tests
All unit tests and [examples](examples) run via [Travis CI](https://travis-ci.com/bitcoinschema/go-bob) and uses [Go version 1.15.x](https://golang.org/doc/go1.15). View the [deployment configuration file](.travis.yml).
