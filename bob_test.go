...
// 3045022100f012c3bd3781091aa8e53cab2ffcb90acced8c65500b41086fd225e48c98c1d702200b8ff117b8ecd2b2d7e95551bc5a1b3bbcca8049864479a28bed9dc842a86804[ALL|FORKID] 03ef5bb22964d529c0af748d9a6381432f05298e7a66ed2fe22e7975b1502528a7

const sampleBobTx2 = `{
  "tx": {
    "h": "207eaadc096849e037b8944df21a8bba6d91d8445848db047c0a3f963121e19d"
  },
  "in": [
    {
      "i": 0,
      "seq": 4294967295,
      "e": {
        "h": "3d1fc854830cb7f5cf4e89459f1e2f4331ffed09ad66a02ce1140c553c9d5af1",
        "i": 1,
        "a": "1FFuYLM8a66GddCG25nUbarazeMr5dnUwC"
      },
      "tape": [
        {
          "i": 0,
          "cell": [
            {
              "b": "MEUCIQDwEsO9N4EJGqjlPKsv/LkKzO2MZVALQQhv0iXkjJjB1wIgC4/xF7js0rLX6VVRvFobO7zKgEmGRHmii+2dyEKoaARB",
              "h": "3045022100f012c3bd3781091aa8e53cab2ffcb90acced8c65500b41086fd225e48c98c1d702200b8ff117b8ecd2b2d7e95551bc5a1b3bbcca8049864479a28bed9dc842a8680441",
              "s": "0E\u0002!\u0000�\u0012ý7�\t\u001a��<�/��\n��eP\u000bA\bo�%䌘��\u0002 \u000b��\u0017��Ҳ��UQ�Z\u001b;�ʀI�Dy����B�h\u0004A",
              "i": 0,
              "ii": 0
            },
            {
              "b": "A+9bsilk1SnAr3SNmmOBQy8FKY56Zu0v4i55dbFQJSin",
              "h": "03ef5bb22964d529c0af748d9a6381432f05298e7a66ed2fe22e7975b1502528a7",
              "s": "\u0003�[�)d�)��t��c�C/\u0005)�zf�/�.yu�P%(�",
              "i": 1,
              "ii": 1
            }
  ...
  "out": [
    {
      ...
      "tape": [
        ...
        },
        {
          ...
          "cell": [
            {
              "b": "5LiA54Gv6IO96Zmk5Y2D5bm05pqX",
              "h": "e4b880e781afe883bde999a4e58d83e5b9b4e69a97",
              "s": "一灯能除千年暗",
              "i": 1,
              "ii": 2
            },
      ...
      "tape": [
        {
          ...
          "cell": [
            ...
            {
              "b": "nGNxXG0fpsYbMdKRFRbhw9s736g=",
              "h": "9c63715c6d1fa6c61b31d2911516e1c3db3bdfa8",
              "s": "�cq\\m\u001f��\u001b1ґ\u0015\u0016���;ߨ",
              "i": 2,
              "ii": 2
            },
...
func TestToTx(t *testing.T) {
	...
	bobTx, err := NewFromString(sampleBobTx2)
	if err != nil {
